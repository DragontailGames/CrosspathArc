...
public class CharacterStatus : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        tilesToRegenHp = totalTilesToRegen - attributeStatus.GetValue(attributeStatus.GetStatus(EnumCustom.Status.HpRegen));//Reseta os tiles para regenerar o Hp
        tilesToRegenMp = totalTilesToRegen - attributeStatus.GetValue(attributeStatus.GetStatus(EnumCustom.Status.MpRegen));//Reseta os tiles para regenerar o Mp
    }
    ...
    public void MoveOneTile()
    {
        ...
        {
            Hp += 1;
            tilesToRegenHp = totalTilesToRegen - attributeStatus.GetValue(attributeStatus.GetStatus(EnumCustom.Status.HpRegen));
        }
        ...
        {
            Mp += 1;
            tilesToRegenMp = totalTilesToRegen - attributeStatus.GetValue(attributeStatus.GetStatus(EnumCustom.Status.MpRegen));
        }
    }
}